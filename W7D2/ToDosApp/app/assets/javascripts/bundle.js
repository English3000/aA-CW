...
exports.createTodo = exports.fetchTodos = exports.removeTodo = exports.receiveTodo = exports.receiveTodos = exports.CREATE_TODO = exports.FETCH_TODOS = exports.REMOVE_TODO = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = undefined;

var _todo_api_util = __webpack_require__(109);

var _error_actions = __webpack_require__(12);
...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    (0, _todo_api_util.APIfetchTodos)().then(function (todos) {
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return (0, _todo_api_util.APIcreateTodo)(todo).then(function (newTodo) {
...
var baseIsTypedArray = __webpack_require__(161),
...
var _todo_app = __webpack_require__(35);

var _todo_app2 = _interopRequireDefault(_todo_app);

var _connector = __webpack_require__(110);
...
var _todo_action = __webpack_require__(11);

var _step_actions = __webpack_require__(63);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.receiveTodos = _todo_action.receiveTodos;
  window.receiveTodo = _todo_action.receiveTodo;
  ...
  window.fetchTodos = _todo_action.fetchTodos;
  window.receiveErrors = _error_actions.receiveErrors;
  window.clearErrors = _error_actions.clearErrors;
  _reactDom2.default.render(_react2.default.createElement(_connector2.default, { store: window.store }), document.getElementById('content')); //OR 'root'
});
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(29),A=__webpack_require__(5),B=__webpack_require__(2),ca=__webpack_require__(30),da=__webpack_require__(31),ea=__webpack_require__(32),ha=__webpack_require__(33),ia=__webpack_require__(34),C=__webpack_require__(8);
...
var mapStateToProps = function mapStateToProps(state, todoId) {
  return {
    todos: (0, _selectors.allToDos)(state),
    steps: (0, _selectors.stepsByTodoId)(state, todoId),
    errors: state.errors
  };
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(24), __webpack_require__(10)(module)))
...
var _todo_list_item = __webpack_require__(107);
  ...
  _createClass(ToDoList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_todo_form2.default, { createTodo: this.props.createTodo, errors: this.props.errors }),
        _react2.default.createElement(
          'ul',
          null,
          this.props.todos.map(function (todo) {
            return _react2.default.createElement(_todo_list_item2.default, { key: todo.title,
              todo: todo,
...
var ToDoForm = function (_React$Component) {
  ...
  function ToDoForm(props) {
    ...
    _this.state = { id: "", title: "", body: "", done: false };
  ...
  _createClass(ToDoForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      event.preventDefault();
      this.state.id = (0, _utils2.default)();
...
var _todo_detail_view = __webpack_require__(108);
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_todo_detail_view2.default, { todo: this.props.todo, detail: this.state.detail })
      );
    }
  }, {
    key: 'handleDelete',
...
exports.APIcreateTodo = exports.APIfetchTodos = undefined;

var _todo_action = __webpack_require__(11);

var APIfetchTodos = exports.APIfetchTodos = function APIfetchTodos() {
  return $.ajax({
    method: 'GET',
    url: '/api/todos'
  });
...
var APIcreateTodo = exports.APIcreateTodo = function APIcreateTodo(todo) {
  return $.ajax({
    method: 'POST',
    url: '/api/todos',
    data: { todo: todo }
...
var Connector = function Connector(_ref) {
  ...
  return _react2.default.createElement(
    ...
    { store: store },
    _react2.default.createElement(_todo_app2.default, null)
  );
};
...
var _thunk = __webpack_require__(182);
...
var _todos_reducer = __webpack_require__(113);

var _todos_reducer2 = _interopRequireDefault(_todos_reducer);

var _steps_reducer = __webpack_require__(180);

var _steps_reducer2 = _interopRequireDefault(_steps_reducer);

var _error_reducer = __webpack_require__(181);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_action.RECEIVE_TODO:
      ...
      return (0, _merge2.default)(newState, state);
